...
namespace PayrollManagement {
    ...
    public partial class EmployeesDataSet : global::System.Data.DataSet {
        ...
        public partial class EmployeesDataTable : global::System.Data.TypedTableBase<EmployeesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public EmployeesRow AddEmployeesRow(string FirstName, string LastName, string Gender, string NINumber, System.DateTime DateOfBirth, string MaritalStatus, bool IsMember, string Address, string City, string PostCode, string Country, string PhoneNumber, string EmailAddress, string Notes) {
        ...
        public partial class EmployeesRow : global::System.Data.DataRow {
            ...
            public string NINumber {
                get {
                    return ((string)(this[this.tableEmployees.NINumberColumn]));
                }
                set {
                    this[this.tableEmployees.NINumberColumn] = value;
                }
            }
            ...
            public bool IsMember {
                get {
                    try {
                        return ((bool)(this[this.tableEmployees.IsMemberColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'IsMember\' in table \'Employees\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableEmployees.IsMemberColumn] = value;
                }
            }
            ...
            public string PostCode {
                get {
                    return ((string)(this[this.tableEmployees.PostCodeColumn]));
                }
                set {
            ...
            public bool IsIsMemberNull() {
                return this.IsNull(this.tableEmployees.IsMemberColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SetIsMemberNull() {
                this[this.tableEmployees.IsMemberColumn] = global::System.Convert.DBNull;
            }
...
namespace PayrollManagement.EmployeesDataSetTableAdapters {
    ...
    public partial class EmployeesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Employees] ([FirstName], [LastName], [Gender], [NINumber], [DateOfBirth], [MaritalStatus], [IsMember], [Address], [City], [PostCode], [Country], [PhoneNumber], [EmailAddress], [Notes]) VALUES (@FirstName, @LastName, @Gender, @NINumber, @DateOfBirth, @MaritalStatus, @IsMember, @Address, @City, @PostCode, @Country, @PhoneNumber, @EmailAddress, @Notes);
SELECT EmployeeID, FirstName, LastName, Gender, NINumber, DateOfBirth, MaritalStatus, IsMember, Address, City, PostCode, Country, PhoneNumber, EmailAddress, Notes FROM Employees WHERE (EmployeeID = SCOPE_IDENTITY())";
...
SELECT EmployeeID, FirstName, LastName, Gender, NINumber, DateOfBirth, MaritalStatus, IsMember, Address, City, PostCode, Country, PhoneNumber, EmailAddress, Notes FROM Employees WHERE (EmployeeID = @EmployeeID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT EmployeeID, FirstName, LastName, Gender, NINumber, DateOfBirth, MaritalSta" +
                "tus, IsMember, Address, City, PostCode, Country, PhoneNumber, EmailAddress, Note" +
        ...
        public virtual int Delete(int Original_EmployeeID, string Original_FirstName, string Original_LastName, string Original_Gender, string Original_NINumber, System.DateTime Original_DateOfBirth, string Original_MaritalStatus, global::System.Nullable<bool> Original_IsMember, string Original_Address, string Original_City, string Original_PostCode, string Original_Country, string Original_PhoneNumber, string Original_EmailAddress, string Original_Notes) {
            ...
            if ((Original_IsMember.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[8].Value = ((bool)(Original_IsMember.Value));
            }
            else {
        ...
        public virtual int Insert(string FirstName, string LastName, string Gender, string NINumber, System.DateTime DateOfBirth, string MaritalStatus, global::System.Nullable<bool> IsMember, string Address, string City, string PostCode, string Country, string PhoneNumber, string EmailAddress, string Notes) {
            if ((FirstName == null)) {
            ...
            if ((NINumber == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[3].Value = ((string)(NINumber));
            }
            ...
            if ((IsMember.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[6].Value = ((bool)(IsMember.Value));
            }
            else {
        ...
        public virtual int Update(
            ...
            if ((NINumber == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[3].Value = ((string)(NINumber));
            }
            ...
            if ((IsMember.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[6].Value = ((bool)(IsMember.Value));
            }
            else {
            ...
            if ((Original_NINumber == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[18].Value = ((string)(Original_NINumber));
            }
            ...
            if ((Original_IsMember.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[22].Value = ((bool)(Original_IsMember.Value));
            }
            else {
